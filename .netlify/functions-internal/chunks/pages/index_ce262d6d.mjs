import { c as createAstro, d as createComponent, r as renderTemplate, f as addAttribute, m as maybeRenderHead, g as renderComponent, h as renderHead, i as renderSlot } from '../astro_66e502e3.mjs';
/* empty css                           */
...
}, "/Users/todd/Repositories/Copus-Law/node_modules/.pnpm/astro@3.2.0/node_modules/astro/components/ViewTransitions.astro", void 0);

const $$Astro$4 = createAstro();
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$4, $$props, $$slots);
  Astro2.self = $$Header;
  return renderTemplate`${maybeRenderHead()}<header class="header" data-astro-cid-3ef6ksr2><h1 data-astro-cid-3ef6ksr2>Header</h1></header>`;
}, "/Users/todd/Repositories/Copus-Law/src/components/Header.astro", void 0);

const $$Astro$3 = createAstro();
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$3, $$props, $$slots);
  Astro2.self = $$Footer;
  return renderTemplate`${maybeRenderHead()}<header class="footer" data-astro-cid-sz7xmlte><h1 data-astro-cid-sz7xmlte>Footer</h1></header>`;
}, "/Users/todd/Repositories/Copus-Law/src/components/Footer.astro", void 0);
...
}, "/Users/todd/Repositories/Copus-Law/src/layouts/Layout.astro", void 0);
